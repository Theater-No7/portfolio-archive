...
都内の大学院で人間工学を専攻している佐藤怜央（@leosato007）です。    
...
AIのサポートを受けながら、以下の技術を用いた開発に挑戦しています。  
日常的な情報収集から資料作成、コーディングまで、様々な場面でAIツールを活用しています。
...
- **GMOペパボ株式会社 | 学生アルバイト (2024/08 ~)**  
  - 『ロリポップ for Gamers』のオウンドメディア運営を担当。
  - SEOを意識した記事の企画・執筆・分析などを行っています。
- **大学弓道サークルの立ち上げ・運営 (2021/04 ~ 2024/03)**
  - 選手として10年以上の経験を活かし、未経験者や留学生を含むインカレサークルを設立。
  - 3年間代表として、30名規模の組織を運営しました。
- **自由が丘 茶乃子 | ホールスタッフアルバイト (2022/02 ~)**
  - 自由が丘の老舗のカフェにて、ホールスタッフとして従事。（今はおやすみ中）
  - 接客を通してコミュニケーション能力と柔軟性の大切さを学びました。
...
- **🎸 音楽 (Music):**
  ...
  - 龍宮城 / BMSG / timelesz / HANA などのアイドルオーディションはほぼ全て追いかけました。
  
- **⛩️ 御朱印集め & カフェ巡り (Traveling & Cafe Hopping):**
  - 御朱印帳は4冊目。京都一人旅では1泊2日で14箇所を巡りました。
  - Googleマップに保存したカフェの数は400件を超えました。

- **✈️ 海外経験 (Overseas Experience):**
  - **短期留学:** アメリカ (セントジョージ / ラスベガス), ポルトガル (ポルト)
  - **旅行:** アメリカ (ハワイ / フロリダ), スペイン (バルセロナ), 台湾 (台北), 韓国 (ソウル), オーストラリア (ケアンズ)

- **🎬 アニメ & 映画 & ゲーム (Media):**
  - **Anime:** ジョジョ5部、コードギアス、NANA
  - **Movie:** インサイド・ヘッド、国宝、1917、Bullet Train
  - **Game:** Minecraft, 第五人格, Angry Birds, 塊魂
  
- **🐈 ネコ (My Cat):**
  - フィガロという名前の3歳のネコと暮らしています。
  - Instagram: [@figaro_sato](https://www.instagram.com/figaro_sato/)
