    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] p-4">
      ...
      <Card className="w-full max-w-md border-gray-200 shadow-xl shadow-blue-50">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-[#0F172A]">Crollaにログイン</CardTitle>
          <CardDescription>
            アカウント情報を入力して管理画面へ進んでください
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm text-[#0055FF] hover:underline">パスワードをお忘れですか？</a>
              </div>
